# Hand Gesture Controlled Browser Python Program
# Code by Ozan Muldur
...
Arduino_Serial = serial.Serial('com6',9600)       # Initialize serial and Create Serial port object called Arduino_Serial
